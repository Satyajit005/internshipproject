...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 03, 2023 at 02:59 PM
...
--
ALTER TABLE `purchase_master`
  MODIFY `purchase_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;

--
-- AUTO_INCREMENT for table `sale_master`
--
ALTER TABLE `sale_master`
  MODIFY `sale_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
